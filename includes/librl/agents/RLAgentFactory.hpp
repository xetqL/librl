...
public:
    ...
    get_instance(std::string algorithm_name,
                 double discount_factor,
                 librl::policy::Policy<State, Action>* policy,
                 librl::approximator::action_value::DoubleApproximator<State, Action>* fa){
        if (!algorithm_name.compare("double-qlearning")) {
            ...
            librl::approximator::action_value::ActionValueApproximator<State, Action>* generic_fa = fa;
    ...
    get_instance(std::string algorithm_name,
                 ...
                 librl::policy::Policy<State, Action>* policy,
                 librl::approximator::action_value::ActionValueApproximator<State,Action>* fa,
                 librl::approximator::state_value::StateValueApproximator<State>* sfa){
